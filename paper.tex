...
Interpreting the entire program as an Exception conforms to the bottom-rewriting rule, but this bypasses the program's exception handling system. So an interpreter should try to avoid this situation.
